        ...
        <div class="modal-header">
         <h5 class="modal-title" id="detailModalLabel<?php echo $dataUser['id']; ?>">Detail Pengguna</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              ...
              <h5 class="card-title text-center"><?php echo $dataUser['nama']; ?></h5>

              <img src="<?php echo $dataUser['foto']; ?>" alt="Foto Pengguna" style="width: 150px; height: 150px;" class="mx-auto d-block">
